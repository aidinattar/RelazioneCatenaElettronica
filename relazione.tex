...
Il valore acquisito da arduino dovrà quindi essere moltiplicato per la slope ($0.7578 \pm 0.0006)$mV
e traslato dell'offset ($-547 \pm 16$) mV 
...
Si specifica che si riporta, per brevità, l'analisi per una una sola forma d'onda, per le altre
si riporteranno solo i risultati notevoli.

...
\begin{figure}
    ...
    \subfloat[][\emph{Residui fit della discesa}]
        {\includegraphics[width=.255\textwidth]{residuishaperdiscesa.pdf}} 
    \subfloat[][\emph{Residui fit della salita}]
        {\includegraphics[width=.255\textwidth]{residuishapersalita.pdf}}
...
$\sigma_{peak}$ tra il picco simulato e acquisito, dove $\sigma_{peak}$ è l'errore associato al massimo: l'errore sui punti della simulazione
...
Le problematiche sono quindi da ricercare in prima battuta sulle calibrazioni e eventualmente su effetti parassiti nel circuito trascurati.
